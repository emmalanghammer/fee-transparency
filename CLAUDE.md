...
is nothing left to press. While disabled it says why, in its `title` and in a sentence beside it —
*"5 charges need details before you can convert."* Both read `ch.incomplete`, which is the n/n's
denominator minus its numerator, so the sentence and the fraction cannot drift. Disabled is RMX's own
